    ...
    public void updateItems(List<Item> items) {
        ...
        if (draggingItem) {
            if (draggedItem != null) {
                ...
                GUI.DrawTexture(new Rect(vectorx - 45, -vectory + Screen.height - 45, 90, 90), draggedItem.itemIcon);
            }
        }
    }
    ...
    public void Checkcrafting() {
        ...
        for (int i = 10; i < 13; i++) {
            if (thisitems[i] != null) {
                ...
                if ((thisitems[i].Name).Equals("WhiteMushroom")) {
                    whitenum = whitenum + thisitems[i].Amount;
                }
        ...
        if (rednum >= 3 && whitenum >= 1) {
            ((UserInventory)player.GetComponent("UserInventory")).AddNew("PurePotion");
        ...
        if (Input.GetMouseButtonUp(0)) {
            if (draggingItem) {
                ...
                if (i != -1) {
                    ...
                    thisitems[previndex] = draggedItem;
                }
            }
        }      
    }
